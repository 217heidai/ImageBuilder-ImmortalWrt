...
## 网卡驱动
PACKAGES="$PACKAGES -kmod-8139cp -kmod-8139too -kmod-bnx2 -kmod-forcedeth -kmod-i40e-vendor -kmod-igb-vendor -kmod-igbvf -kmod-igc -kmod-ixgbe-vendor -kmod-ixgbevf-vendor -kmod-pcnet32 -kmod-r8101 -kmod-r8125 -kmod-r8168 -kmod-tg3 -kmod-tulip"
## USB驱动
